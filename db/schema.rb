...
ActiveRecord::Schema.define(version: 20141230010557) do
  ...
  add_index "taggings", ["tag_topic_id", "shortened_url_id"], name: "index_taggings_on_tag_topic_id_and_shortened_url_id", unique: true, using: :btree
